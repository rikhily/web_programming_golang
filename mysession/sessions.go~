...
func init() {
    ...
    mytemp = template.Must(template.ParseFiles("form.html","formhandler.html","link1.html","link2.html"))
}
...
func formhandler(w http.ResponseWriter, r *http.Request) {
    ...
    err := mytemp.ExecuteTemplate(w, "formhandler.html", struct{
        ...
        Url string
        Message string
        }{r.FormValue("name"),r.FormValue("url"),r.FormValue("msg")})
...
func linkone(w http.ResponseWriter, r *http.Request) {
    thisuser := r.FormValue("name")+" "+r.FormValue("url")+" "+r.FormValue("message")
